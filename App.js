...
import { AppRegistry, NativeAppEventEmitter, NativeModules, View } from 'react-native';
import {
  ZaptMap,
  getMapLink,
  addLocationListener,
...
const placeID = '-nanzq4qchihwq1jc3wf';
...
class App extends Component {
  ...
  render() {
    return <GluestackUIProvider config={config.theme}>
        <Box bg="$primary500"
        p="$5"
      >
        <Text color="white">
